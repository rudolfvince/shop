...
class Phoenix_WirecardQPay_Model_Invoice extends Phoenix_WirecardQPay_Model_Abstract
{
    /**
    ...
    **/
    ...
    public function getCustomerDob()
    {
        ...
        if($additionalInfo->hasAdditionalInformation('qenta_invoice_dob'))
        {
            $dob = $additionalInfo->getAdditionalInformation('qenta_invoice_dob');
            if($dob)
            {
