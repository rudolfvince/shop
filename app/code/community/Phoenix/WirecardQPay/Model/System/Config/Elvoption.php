...
class Phoenix_WirecardQPay_Model_System_Config_Elvoption
{
    ...
    {
        return array(
            array('value' => 0, 'label'=>Mage::helper('qpay')->__('Full Bank-Data')),
            array('value' => 1, 'label'=>Mage::helper('qpay')->__('Bic / Iban')),
        );
    }
