...
class Phoenix_WirecardQPay_Model_BanContactMisterCash extends Phoenix_WirecardQPay_Model_Abstract
{  
    /**   
    ...
    * @var string [a-z0-9_]   
    **/
    protected $_code = 'qenta_banContactMisterCash';
    protected $_formBlockType = 'qpay/form';
    protected $_infoBlockType = 'qpay/info';
    protected $_paymentMethod = 'BANCONTACT_MISTERCASH';
}
?>