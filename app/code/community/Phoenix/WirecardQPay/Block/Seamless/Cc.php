...
class Phoenix_WirecardQPay_Block_Seamless_Cc extends Mage_Payment_Block_Form_Cc
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qpay/seamless/cc.phtml');
    }

    public function showIssueDate()
    {
        return Mage::getStoreConfigFlag('payment/qenta_cc/show_issue_date', Mage::app()->getStore()->getId());
    }

    public function showIssueNumber()
    {
        return Mage::getStoreConfigFlag('payment/qenta_cc/show_issue_number', Mage::app()->getStore()->getId());
    }
}