...
class Phoenix_WirecardQPay_Block_Seamless_Elv extends Phoenix_WirecardQPay_Block_Seamless_Abstract
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qpay/seamless/elv.phtml');
    }
    
    /**
     * This Payment Method has two Options:
     * - Full Bankdata
     * - Iban / Bic
     * Here we retrive which Template should be used
     * 
     *  @return string
     */
    public function getPaymentDataOption()
    {
        return Mage::getStoreConfig('payment/qenta_elv/seamless_option', Mage::app()->getStore()->getId());
    }
}