...
class Phoenix_WirecardQPay_Block_Seamless_Idl extends Phoenix_WirecardQPay_Block_Seamless_Abstract
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qpay/seamless/idl.phtml');
    }

    public function getFinancialInstitutions()
    {
        return WirecardCEE_Client_QPay_Request_Initiation_PaymentType::getFinancialInstitutions(WirecardCEE_Client_QPay_Request_Initiation_PaymentType::IDL);
    }
}